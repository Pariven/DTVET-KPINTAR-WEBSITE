    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-xl p-8 text-center">
        <div className="mb-6">
          ...
          <div className="text-yellow-800 bg-yellow-100 rounded-lg px-4 py-3 mt-4 mb-2 text-base font-medium">
            Our customer service will be contacting you in 24 hours to access the programme you had purchased.
          </div>
        </div>
